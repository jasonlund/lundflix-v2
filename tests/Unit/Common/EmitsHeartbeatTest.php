...
describe('beat() boundary emission', function (): void {
...
describe('mark() on-demand lines', function (): void {
...
describe('flushTotal() closing total', function (): void {
...
describe('failureSummary() run failures', function (): void {
