...
describe('extract() real Plex items', function (): void {
...
describe('extract() Guid[] and top-level precedence', function (): void {
...
describe('extract() malformed ids', function (): void {
...
describe('extract() returned key set', function (): void {
