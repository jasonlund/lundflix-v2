...
describe('GET /register form access', function () use ($verifiedPlexAccount): void {
...
describe('POST /register account creation', function () use ($verifiedPlexAccount): void {
...
describe('POST /register refusals', function () use ($verifiedPlexAccount): void {
