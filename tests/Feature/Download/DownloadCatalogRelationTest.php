...
it('resolves the Movie sharing its _imdb_id', function () {
    // Arrange
...
it('resolves the Show sharing its _imdb_id', function () {
    // Arrange
...
it('resolves both relations to null for a null _imdb_id', function () {
    // Arrange
