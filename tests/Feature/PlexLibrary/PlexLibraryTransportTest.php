...
describe('fetchSections() directory', function (): void {
...
describe('fetchSectionItems() page walk', function (): void {
...
describe('fetchShowLeaves() materialized return', function (): void {
