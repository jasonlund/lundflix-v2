...
describe('handle() crosswalk normalization', function (): void {
...
describe('handle() row identity and duplicates', function (): void {
...
describe('handle() defaultSeasonType mapping', function (): void {
...
describe('handle() TheMovieDB.com id collisions', function (): void {
