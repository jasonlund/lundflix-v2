...
return [
    ...
    /*
     * Settings classes are registered explicitly above (they live under their
     * owning domain, e.g. App\Domains\Download\Settings, not a single app/Settings
     * tree). Auto-discovery is disabled so the package's Finder never scans a
     * non-existent path.
     */
